...
pub(crate) struct Options {
    ...
    /// Whether every configured relay connection should remain active.
    pub(crate) keep_relays_connected: bool,

    /// Idle timeout for non-home relay connections.
    pub(crate) relay_inactive_cleanup_time: Duration,
}
...
impl Actor {
    ...
    async fn handle_relay_map_change(&mut self) {
        self.transports_network_change.relay_map_change().await;
