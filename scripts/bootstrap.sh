...
if [[ ! -x "${TOOLS}/cargo/bin/rustc" ]]; then
...
if [[ ! -x "${TOOLS}/bin/staticcheck" ]]; then
...
if [[ ! -x "${TOOLS}/cargo/bin/cargo-audit" ]]; then
...
if [[ ! -x "${TOOLS}/cargo/bin/cargo-deny" ]]; then
