...
paths=(
  ...
  control-plane/internal/api/login.go control-plane/internal/operations/dispatch.go
  ...
  control-plane/internal/auth/store_test.go control-plane/internal/auth/testdata/fixture.sql
