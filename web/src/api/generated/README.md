...
| _NodesApi_         | [**createPrivdAttestationCredential**](docs/NodesApi.md#createprivdattestationcredential) | **POST** /nodes/{node_id}/privd-attestation-credentials    | Create a root-provisioning-only one-time privd key credential                    |
...
| _NodesApi_         | [**registerPrivdAttestationKey**](docs/NodesApi.md#registerprivdattestationkey)           | **POST** /nodes/{node_id}/privd-attestation-keys:register  | Atomically consume root provisioning proof and bind a privd key                  |
...
- [PrivdAttestationCredential](docs/PrivdAttestationCredential.md)
- [PrivdAttestationCredentialRequest](docs/PrivdAttestationCredentialRequest.md)
- [PrivdAttestationKeyState](docs/PrivdAttestationKeyState.md)
- [PrivdAttestationKeyStateMetric](docs/PrivdAttestationKeyStateMetric.md)
- [PrivdAttestationRegistration](docs/PrivdAttestationRegistration.md)
- [PrivdAttestationRevokeRequest](docs/PrivdAttestationRevokeRequest.md)
- [PrivdReceiptVerificationMetric](docs/PrivdReceiptVerificationMetric.md)
